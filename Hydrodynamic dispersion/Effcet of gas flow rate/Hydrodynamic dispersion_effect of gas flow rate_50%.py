...
# --- Input datasets: update paths as needed ---
data_paths = [
...
gas_flow_rates = [0.05, 0.25, 0.50]  # [L/min] legend/x-axis values

# --- Output folder (created if missing) ---
output_dir = r"C:\python files\Hydrogel_Three-phase\Figures\New results\Hydrodynamic dispersions\Effect of gas phase\50%"
...
# Dataset folders (SVF = 30%, varying gas rate)
data_paths = [
...
# Output directory
output_dir = r"C:\python files\Hydrogel_Three-phase\Figures\New results\Hydrodynamic dispersions\Effect of gas phase\30%"
