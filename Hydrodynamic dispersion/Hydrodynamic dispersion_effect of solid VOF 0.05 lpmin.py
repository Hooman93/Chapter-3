...
#   solid volume fractions (SVF) at a fixed gas flow rate (0.05 L/min)
...
#     (0.05 L/min). Legends, plot titles, and Excel columns use SVF
...
gas_rate_Lmin = 0.05            # [L/min] same for all SVF cases
...
output_dir = r"C:\python files\Hydrogel_Three-phase\Figures\New results\Hydrodynamic dispersions\Effect of solid VOF\0.05 Lpmin"
