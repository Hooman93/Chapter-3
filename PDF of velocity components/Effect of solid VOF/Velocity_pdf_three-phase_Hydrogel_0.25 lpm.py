...
output_root = r"C:\python files\Hydrogel_Three-phase\Figures\New results\Velocity distribution anlayis_varying solid VOF\0.25"  # Where figures/results will be written
