...
# - Computes hydrodynamic dispersion via MSD(τ) for Y and X+Z, plots curves, fits D      #
# - Saves plots (PNG+SVG), dispersion curve CSVs, optional PDF CSVs, and stats to Excel  #
# - NEW: Draw |V| boxplots per case (with means), including a version without outliers   #
# ============================================
...
data_paths = [
    ...
    r"E:\Three-phase Hydrogels\track data_dispersion\Three-phase\10%\0.05 lpermin\dipersion calculation_10% (images 500-1000)_0.05 lpmin",
    ...
    r"E:\Three-phase Hydrogels\track data_dispersion\Three-phase\50%\0.05 lpermin\dipersion calculation_50% (images 500-1000)_0.05 lpmin",
]

output_root = r"C:\python files\Hydrogel_Three-phase\Figures\New results\Velocity distribution anlayis_varying solid VOF\0.05"
