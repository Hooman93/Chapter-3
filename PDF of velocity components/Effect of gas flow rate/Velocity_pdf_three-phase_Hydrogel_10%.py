...
#median filtered data_2 seconds of flow (images 1500-2500)
# data_paths = [
#     r"E:\Three-phase Hydrogels\New track data_1000 images_spatialmedian filtered\0.05 lpermin\10%\Median filtered_Images_1500-2500_For track analysis_10%_0.05 lpmin",
#     r"E:\Three-phase Hydrogels\New track data_1000 images_spatialmedian filtered\0.25 lpermin\10%\Median filtered_Images_1500-2500_For track analysis_10%_0.25 lpmin",
#     r"E:\Three-phase Hydrogels\New track data_1000 images_spatialmedian filtered\0.5 lpermin\10%\Median filtered_Images_1500-2500_For track analysis_10%_0.5 lpmin",
# ]
...
data_paths = [                         # List of dataset directories to process (each item = one condition/case)
    r"E:\Three-phase Hydrogels\track data_dispersion\Three-phase\10%\0.05 lpermin\dipersion calculation_10% (images 500-1000)_0.05 lpmin",  # raw string â†’ backslashes not escaped
    r"E:\Three-phase Hydrogels\track data_dispersion\Three-phase\10%\0.25 lpermin\dipersion calculation_10% (images 500-1000)_0.25 lpmin",  # 0.25 L/min condition
    r"E:\Three-phase Hydrogels\track data_dispersion\Three-phase\10%\0.5 lpermin\dipersion calculation_10% (images 500-1000)_0.5 lpmin",    # 0.5 L/min condition
]

output_root = r"C:\python files\Hydrogel_Three-phase\Figures\New results\velocity distribution analysis_varying gas flow rate\10%"  # Where figures/results will be written
